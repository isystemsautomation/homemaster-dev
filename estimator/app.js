...
function simpleHomemasterPriceHtml(comm) {
  ...
  if (!hm) {
    return `<div class="hm-card hm-hm-price">
      ...
      <p class="hm-hm-price__stock hm-muted">${escapeAttr(stock)}</p>
    </div>`;
  }
  return `<div class="hm-card hm-hm-price">
    <h3 class="hm-hm-price__h">HomeMaster modules</h3>
    ...
    <p class="hm-hm-price__tag">exact current shop price</p>
    <p class="hm-hm-price__stock">${escapeAttr(stock)}</p>
  </div>`;
}
...
function simpleOtherMaterialsHtml(comm) {
  ...
  return `<details class="hm-card hm-mat">
    ...
    <p class="hm-mat__note">Not sold by HomeMaster · not added to cart</p>
    ${cats}
...
function simpleCompleteHardwareHtml(comm) {
  ...
  const mats = comm.otherMaterialsEstimatedTotal;
  if (full) {
    return `<div class="hm-card hm-complete">
  ...
  return `<div class="hm-card hm-complete hm-complete--incomplete">
    <h3 class="hm-complete__h">Complete hardware for this panel</h3>
 ...
 * @param {ReturnType<typeof buildCommercialSummary>} comm
 */
function simpleFieldSideHtml(comm) {
  ...
  const rows = items
    ...
    .join("");
  return `<div class="hm-card hm-field">
    <h3 class="hm-field__h">Field side — quoted by your installer</h3>
    <ul class="hm-field__list">${rows}</ul>
  </div>`;
}

function simpleInstallationHtml(comm) {
  ...
  return `<div class="hm-card hm-installation">
    <h3 class="hm-installation__h">Installation — not included</h3>
...
function simpleInstallerHtml(directory, countryId) {
  ...
  return `<div class="hm-card hm-installer" id="s-installer">
...
function mountConfigurator(root) {
    ...
    <div class="hm-estimator">
      <header class="hm-estimator__header">
        ...
        <div class="hm-estimator__mode-row">
          ...
          <button type="button" id="hm-mode-detail" class="hm-mode-detail">Configure in detail</button>
        </div>
      </header>
  ...
  const modeDetailBtn = shell.querySelector("#hm-mode-detail");
  ...
  modeDetailBtn.addEventListener("click", () => setUiMode("advanced"));
  ...
  async function paintSimpleResult() {
    ...
    host.innerHTML = `
      ...
      ${simpleFieldSideHtml(comm)}
      ${simpleInstallationHtml(comm)}
      ${simpleInstallerHtml(directory, installerCountryId)}
      <div class="hm-card hm-simple-actions-secondary">
